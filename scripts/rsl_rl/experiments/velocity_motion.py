...
parser = argparse.ArgumentParser(description="Analyze vel motion with diagonal velocity command.")
...
parser.add_argument("--output_dir", type=str, default="experiments/velocity_motion", help="Directory to save results.")
...
def run_experiment():
    ...
    visualize_vel_motion(data_collection, output_dir, args_cli.dt)
...
def visualize_vel_motion(data_collection, output_dir, dt):
    ...
    ax1.set_title(f'Velocity Controlled Motion Analysis: Diagonal Movement (vx={args_cli.vx}, vy={args_cli.vy} m/s)', fontsize=13)
    ...
    # Save figure
    output_path = output_dir / 'velocity_motion.png'
...
def save_data(data_collection, output_dir):
    ...
    # Save detailed data
    csv_path = output_dir / 'velocity_motion_data.csv'
